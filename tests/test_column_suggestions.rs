...
fn test_column_typo_suggestions() {
    ...
    assert!(
        ...
        "Error should suggest 'ship_date', got: {}",
        error_msg
    );
}
...
fn test_column_typo_suggestions_swap() {
    ...
    assert!(
        ...
        "Error should suggest 'customer_name', got: {}",
        error_msg
    );
}
...
fn test_no_suggestion_for_very_different_names() {
    ...
    assert!(
        ...
        "Should not suggest anything for very different names, got: {}",
        error_msg
    );
    assert!(
        error_msg.contains("Column 'xyz_field' not found"),
        "Should show standard error, got: {}",
        error_msg
    );
}
...
fn test_where_clause_column_suggestions() {
    ...
    assert!(
        ...
        "Error should mention the column name, got: {}",
        error_msg
    );
}
