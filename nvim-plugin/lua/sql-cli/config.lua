...
M.defaults = {
  ...
  keymaps = {
    ...
    execute_at_cursor = "<leader>sx", -- Execute query at cursor (auto-detects scripts with GO)
    execute_statement_at_cursor = "<leader>sd", -- Execute statement with dependencies (explicit)
    ...
    show_transformations = "<leader>sz", -- Show transformation pipeline (QUALIFY, window functions, etc.)
    ...
    -- Cache management
    cache_purge = "<leader>scp",    -- Purge all cache entries (lowercase cp for cache purge)
