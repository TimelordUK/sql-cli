...
impl SmartSqlParser {
    ...
    fn classify_token(&self, token: &str) -> SqlToken {
        ...
        match upper_token.as_str() {
            ...
            "GROUP" | "HAVING" | "LIMIT" | "OFFSET" | "ASC" | "DESC" => {
                SqlToken::Keyword(upper_token)
            }
            _ => {
    ...
    fn determine_parse_state(&self, tokens: &[SqlToken], partial_token: &Option<String>) -> ParseState {
    ...
    fn filter_suggestions(&self, suggestions: Vec<String>, partial: &Option<String>) -> Vec<String> {
